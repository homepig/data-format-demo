...
public class OutputInvoice {
    public static void main(String[] args) {
        ...
        // dws层
        String dwsFilePath = "E:\\data-format-demo\\src\\main\\resources" + File.separator + "销项发票ads.xls";
...
//            dictBaseDataUtil.odsCreateDDL("", "", jsonString);
        ...
        if (dwsFilePath != null && !"".equals(dwsFilePath)) {
            dictBaseDataUtil.dwsCreateDDL("pro_output_invoice_d", "销项发票", dwsFilePath);
        }
    }
}
